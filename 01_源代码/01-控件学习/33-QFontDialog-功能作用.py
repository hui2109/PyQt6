...
class Window(QWidget):
    ...
    def setup_ui(self):
        ...
        # fd = 29-QFontDialog(self)
        font = QFont()
        font.setFamily("宋体")
        font.setPointSize(36)
        # # fd = 29-QFontDialog(font, self)
        # fd = 29-QFontDialog(self)
        # fd.setCurrentFont(font)
        # # fd.setOption(29-QFontDialog.NoButtons)
        # fd.setOptions(29-QFontDialog.NoButtons | 29-QFontDialog.MonospacedFonts)
        # print(fd.testOption(29-QFontDialog.MonospacedFonts))
        # print(fd.testOption(29-QFontDialog.ScalableFonts))
        ...
        def font_sel():
            pass
        # result = 29-QFontDialog.getFont(self)
        #     result = 29-QFontDialog.getFont(font,self,"选择一个好看的字体")
        #     if result[1]:
