...
class MyWindow(QWidget):
    ...
    def initWidgets(self):
        ...
        # form_layout.removeRow(h_box)

        # trr=form_layout.takeRow(h_box)
        # print(trr.labelItem.widget())
        # print(trr.fieldItem.layout())

        # form_layout.removeWidget(line_name)
        form_layout.removeWidget(label_name)
