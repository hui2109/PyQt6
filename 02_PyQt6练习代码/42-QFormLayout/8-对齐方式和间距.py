...
class MyWindow(QWidget):
    def __init__(self,*args,**kwargs):
        ...
        self.resize(500,500)
        self.setWindowTitle('对齐方式和间距的学习')
        self.move(100,100)
        self.initWidgets()
    def initWidgets(self):
        ...
        print(form_layout.formAlignment())
        form_layout.setFormAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignBottom)
        form_layout.setVerticalSpacing(60)
        form_layout.setHorizontalSpacing(60)
